...
public:
      ...
      nh(), spinner(0), it(nh) ,show_2D_tracks(show_2D_tracks), number_of_frames_for_static_background(number_of_frames_for_static_bs)
  {
    ...
    topicColor = "/" + cameraName + "/" + K2_TOPIC_SD K2_TOPIC_IMAGE_COLOR K2_TOPIC_IMAGE_RECT; //K2_TOPIC_LORES_COLOR K2_TOPIC_RAW;
    topicDepth = "/" + cameraName + "/" + K2_TOPIC_SD K2_TOPIC_IMAGE_DEPTH; //K2_TOPIC_LORES_DEPTH K2_TOPIC_RAW;
